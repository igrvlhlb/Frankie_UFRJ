...
frankie_open = '''                                                                                                                                                                                                                                                                  
BEM VINDO À PLATAFORMA FRANKIE
'''

frankie_robot = '''
ESTE É UM PROJETO LABZERO/UFRJ - ESCOLA SESC DE ENSINO MéDIO
'''

frankie_speak_4 = '''
REGULAGEM DOS DISPOSITIVOS ROBÓTICOS                                                                         
'''
frankie_speak_5 = '''
[FRANKIE] Digite a Distância até a Imagem (De 5 a 10):
[VOCÊ]: '''

frankie_speak_6 = '''
[FRANKIE] Digite a Velocidade dos motores (De 50 a 100):
[VOCÊ]: '''

frankie_speak_8 = '''
[FRANKIE] Digite o tempo que o Frankie irá virar para a direita ou para a esquerda (De 1 a 3):
[VOCÊ]: '''

frankie_speak_10 = '''
[FRANKIE] Digite o tempo que o Frankie irá para frente ou para tras (De 1 a 3):
[VOCÊ]: '''

frankie_speak_12 = '''
REGULAGENS DO NÚMERO DE PIXELS DA RETINA
'''
...
frankie_speak_14 = '''
REGILAGENS DA REDE NEURAL WIZARD                                 
'''
...
speak(frankie_open, 0.01)
speak(frankie_robot, 0.01)

speak(frankie_speak_4, 0.01)

speak(frankie_speak_5, 0.01)
distancia = valida_valor(5, 10)

speak(frankie_speak_6, 0.01)
velocidade_m = valida_valor(50, 100)

speak(frankie_speak_8, 0.01)
time_ft = valida_valor(1, 3)

speak(frankie_speak_10, 0.01)
time_de = valida_valor(1, 3)
...
def irFrente ():
    motor_pwm1.start(velocidade_m)#75
    motor_pwm2.start(velocidade_m)
    GPIO.output(17,1)
    GPIO.output(22,0)
    GPIO.output(27,1)
    GPIO.output(23,0)
